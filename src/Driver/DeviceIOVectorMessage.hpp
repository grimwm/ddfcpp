#ifndef DEVICE_IO_VECTOR_MESSAGE_HPP__
#define DEVICE_IO_VECTOR_MESSAGE_HPP__

#include "DeviceBaseMessage.hpp"

namespace SymbolX
{
  /// @brief Specializes messages related to scattering and gathering.
  class DeviceIOVectorMessage : public DeviceBaseMessage
  {
  public:
    /// @brief Constructor.
    /// @param msg OS-specific IPC message to wrap.
    inline DeviceIOVectorMessage(IPCMessageType *msg) :
      DeviceBaseMessage(msg) {}

    /// @brief Destructor.
    virtual ~DeviceIOVectorMessage() {}
